...
address1 = "/home/shared/01_results_24_11_14/decay_-070_rate_-020_AR1_SR14"
commands_processor_1 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address1}" --activation_mode rate --activation_variation -0.2 --aortic_resistance 1 --systematic_resistance 14',
...
address2 = "/home/shared/01_results_24_11_14/decay_-070_rate_-020_AR2p5_SR12p5"
commands_processor_2 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address2}" --activation_mode rate --activation_variation -0.2 --aortic_resistance 2.5 --systematic_resistance 12.5',
...
address3 = "/home/shared/01_results_24_11_14/decay_-070_rate_-020_AR1_SR20"
commands_processor_3 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address3}" --activation_mode rate --activation_variation -0.2 --aortic_resistance 1 --systematic_resistance 20',
...
address4 = "/home/shared/01_results_24_11_14/decay_-070_rate_-020_AR2p5_SR15"
commands_processor_4 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address4}" --activation_mode rate --activation_variation -0.2 --aortic_resistance 2.5 --systematic_resistance 15',
...
address5 = "/home/shared/01_results_24_11_14/decay_-070_rate_-020_AR5_SR20"
commands_processor_5 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address5}" --activation_mode rate --activation_variation -0.2 --aortic_resistance 5 --systematic_resistance 20',
...
address6 = "/home/shared/01_results_24_11_14/decay_-070_rate_-020_AR5_SR25"
commands_processor_6 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address6}" --activation_mode rate --activation_variation -0.2 --aortic_resistance 5 --systematic_resistance 25',
