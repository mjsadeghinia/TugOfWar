...
address1 = "/home/shared/01_results_24_11_14/decay_+030"
commands_processor_1 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address1}" --activation_mode decay --activation_variation .3',
...
address2 = "/home/shared/01_results_24_11_14/decay_-030"
commands_processor_2 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address2}" --activation_mode decay --activation_variation -.3',
...
address3 = "/home/shared/01_results_24_11_14/aortic_resistance_3"
commands_processor_3 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address3}" --aortic_resistance 3',
...
address4 = "/home/shared/01_results_24_11_14/aortic_resistance_2"
commands_processor_4 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address4}" --aortic_resistance 2',
