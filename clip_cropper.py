...
if __name__ == "__main__":
    folder_path = "/home/shared/01_results_24_11_29_video"  # Replace with your folder path
    rectangle_percentage = (0.35, 0, 0.35, 0.95)  # Crop rectangle as percentages (x%, y%, width%, height%)
