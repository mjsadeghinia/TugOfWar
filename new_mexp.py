...
address1 = "/home/shared/01_results_25_04_02_test/2_fibers-60to60_ep"
commands_processor_1 = [
    f'python3 TugOfWar/tug_of_war.py -ep -o "{address1}" --fiber_angle_endo -60 --fiber_angle_epi 60',
...
address2 = "/home/shared/01_results_25_04_02_test/3_fibers-60to60_ep_rn_crn_05"
commands_processor_2 = [
    f'python3 TugOfWar/tug_of_war.py -crn -rn -ep -o "{address2}" --fiber_angle_endo -60 --fiber_angle_epi 60 --crn_std 0.05',
...
address3 = "/home/shared/01_results_25_04_02_test/3_fibers-60to60_ep_rn_crn_02"
commands_processor_3 = [
    f'python3 TugOfWar/tug_of_war.py -crn -rn -ep -o "{address3}" --fiber_angle_endo -60 --fiber_angle_epi 60 --crn_std 0.02',
...
address4 = "/home/shared/01_results_25_04_02_test/3_fibers-60to60_ep_crn"
commands_processor_4 = [
    f'python3 TugOfWar/tug_of_war.py -crn -ep -o "{address4}" --fiber_angle_endo -60 --fiber_angle_epi 60 --crn_std 0.05',
...
address5 = "/home/shared/01_results_25_04_02_test/3_fibers-60to60_ep_notime-rn_crn"
...
address6 = "/home/shared/01_results_25_04_02_test/3_fibers-60to60_ep_rn_crn_05_mi"
commands_processor_6 = [
    f'python3 TugOfWar/tug_of_war.py -mi -crn -rn -ep -o "{address6}" --fiber_angle_endo -60 --fiber_angle_epi 60 --crn_std 0.05',
...
address7 = "/home/shared/01_results_25_04_02_test/3_fibers-60to60_ep_rn_crn_05_micomp"
commands_processor_7 = [
    f'python3 TugOfWar/tug_of_war.py -mi -micomp -crn -rn -ep -o "{address7}" --fiber_angle_endo -60 --fiber_angle_epi 60 --crn_std 0.05',
